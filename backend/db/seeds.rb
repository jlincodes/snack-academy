...
Product.create!(name: 'Cheezits', price: 200, description: 'Fun size bag', category: 'food', inventory: rand(10), img_url: 'https://www.staples-3p.com/s7/is/image/Staples/s0926619_sc7?$splssku$')
Product.create!(name: 'Doritos Nacho', price: 150, description: '10 oz. bag', category: 'food', inventory: rand(10), img_url: 'https://target.scene7.com/is/image/Target/14930889?wid=520&hei=520&fmt=pjpeg')
Product.create!(name: 'Cup Ramen', price: 150, description: 'Original Size', category: 'food', inventory: rand(10), img_url: 'https://i.pinimg.com/originals/c4/df/49/c4df4970e13dcd0db7d4c84cffb15cd7.jpg')
Product.create!(name: 'Sour Patch Kids', price: 300, description: 'Fun size bag', category: 'food', inventory: rand(10), img_url: 'https://petraacademy.com/wp-content/uploads/2016/02/Sour-patch-kids-image.jpg')
Product.create!(name: 'Altoids', price: 400, description: 'Curiously Strong', category: 'food', inventory: rand(10), img_url: 'https://target.scene7.com/is/image/Target/13304773?wid=325&hei=325&qlt=80&fmt=pjpeg')
